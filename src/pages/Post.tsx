...
export const Post = () => {
    ...
    const schemaData = postData ? {
        ...
        "image": postData.mainImage ? [urlFor(postData.mainImage).width(1200).height(630).url()] : ['https://entrenamientoaguasabiertas.com/og-image.jpg'],
        "datePublished": postData.publishedAt ? new Date(postData.publishedAt).toISOString() : '',
        "author": [{
            "@type": "Person",
            "name": postData.authorName || 'Sergi García',
            "url": "https://entrenamientoaguasabiertas.com/sobre-mi"
        }],
        "publisher": {
            "@type": "Organization",
            "name": "Sergi Swim Coach",
            "logo": {
                "@type": "ImageObject",
                "url": "https://entrenamientoaguasabiertas.com/favicon.png"
            }
        },
        "mainEntityOfPage": {
            "@type": "WebPage",
            "@id": `https://entrenamientoaguasabiertas.com/blog/${slug}`
        }
    } : undefined;
    ...
    useSEO({
        ...
        canonical: postData ? `https://entrenamientoaguasabiertas.com/blog/${slug}` : undefined,
        ogImage: postData?.mainImage ? urlFor(postData.mainImage).width(1200).height(630).url() : undefined,
        ogType: 'article',
        schema: schemaData
    });
